...
A two-part printed housing for a Ø25 mm NFC sticker: a cup and a press-fit cap. No
screws, no supports, no glue required. Both parts come off one plate in well under
an hour and use about 20¢ of filament.
...
| `floor_t` | 2.0 | Bottom. |
| `lid_t` | 1.0 | **The critical one.** Plastic between tag and phone. Five layers at 0.2. Do not exceed 1.5. |
...
Derived: bore Ø36.0, plug Ø35.8, tag cavity Ø26.0 × 3.0 deep, and a Ø36 × 4.0
ballast well in the floor of the body.

```
        ┌──────────────────────────┐  ← tap here
        │▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓│  lid_t 1.0  (all that's between tag and phone)
        │███░░░░░ NFC ░░░░░░░░░████│  cavity Ø26 × 3.0, sticker adhered to the roof
        ├───┬──────────────────┬───┤  plug Ø35.8 into bore Ø36.0
        │   │                  │   │
        │   │   ballast well   │   │  Ø36 × 4.0 — coins, washers, sand, or nothing
        │   │                  │   │
        │   └──────────────────┘   │  floor 2.0
...
- 4 perimeters, 20 % infill, 5 top and bottom layers.
...
3. Press the lid home until the flange sits flat on the rim.
